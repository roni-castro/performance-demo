...
const CartProductsGrid = () => {
  ...
  return (
    <FlatList
      ...
      refreshControl={
        <RefreshControl refreshing={isRefreshing} onRefresh={refreshPosts} tintColor="#000" />
      }
      onEndReached={onEndReached} 
      ListFooterComponent={isFetching && !isRefreshing ? <ActivityIndicator size="large" color="#000" /> : null}
    />
  );
};
